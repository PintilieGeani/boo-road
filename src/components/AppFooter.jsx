const Footer = () => {
    return (
            ...
            <footer className="bg-dark text-white text-center text-lg-start border-top border-white mt-xl-5 pt-4">
                ...
                <div className="container p-4">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                            ...
                            <button type="submit" className="btn btn-outline-light btn-block">Subscribe</button>
                        </div>
                    </div>
                </div>
